package cl.integracion.ms_sales_bs.service;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;

import cl.integracion.ms_sales_bs.clients.*;
import cl.integracion.ms_sales_bs.model.dto.ProductDTO;
import cl.integracion.ms_sales_bs.model.dto.SaleDTO;
import cl.integracion.ms_sales_bs.model.dto.SalesDTO;
import cl.integracion.ms_sales_bs.model.dto.SalesDetailDTO;
import cl.integracion.ms_sales_bs.model.dto.WebPayTransacionDTO;
import cl.integracion.ms_sales_bs.model.dto.WebPayTransactionQueryResponseDTO;
import cl.integracion.ms_sales_bs.model.dto.WebPayTransactionRequestDTO;
import cl.integracion.ms_sales_bs.model.dto.WebPayTransactionResponseDTO;
...
public class SaleService {
    ...
    try {
        String response = webPayFeignClient.confirmTransaction(
            "597055555532",
            "579B532A7440BB0C9079DED94D31EA1615BACEB56610332264630D42D0A36B1C",
            webPayTransacionDTO.getToken()
        );
        log.info("confirmTransaction: {}", response);
        return response;
    } catch (Exception e) {
        log.error("Error confirmando transacción WebPay: {}", e.getMessage(), e);
        // Puedes retornar un mensaje de error personalizado o relanzar la excepción
        return "Error confirmando transacción: " + e.getMessage();
    }
}
    ...
    public SalesDTO insertSale(SalesDTO saleDTO) {
        ...
        if (dto != null && dto.getSalesDetailDtoList() != null) {
